...
from modelsM.model import create_model, load_model
from modelsM.decode import mot_decode
...
from utilsM.image import ctdet_post_process
from utilsM.image import get_affine_transform
...
class JDETracker(object):
    ...
    def update(self, im_blob, img0):
        ...
        with torch.no_grad():
            ...
            # print('output', output['hm'].shape, output['wh'].shape, output['id'].shape, output['reg'].shape, output['hm'].sigmoid_().shape)
